...
async def setup_profile(event):
    ...
    form_link = f"https://competetor-micro-service-production.up.railway.app/profile_form?user_id={user_id}"
...
async def handle_job_description(event):
    ...
    response = requests.post("https://competetor-micro-service-production.up.railway.app/generate_cover_letter", json=user_data)
